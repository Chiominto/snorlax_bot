...
MAIN_DIVIDER = Dividers.moon
STAFF_THUMBNAIL = Thumbnails.moon
START_THUMBNAIL = Thumbnails.moon
PUBLIC_THUMBNAIL = Thumbnails.moon
PUBLIC_EMOJI = "🌙"  # moon, calm night vibe
STAFF_EMOJI = "💤"  # sleep bubbles, Snorlax’s signature
TITLE_EMOJI = "🐻"  # bear-like, cuddly Snorlax feel
FOOTER_EMOJI = "🍩"  # sweet snack, fits Snorlax’s love for food
